<template>
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        x="0px" y="0px" width="40px" viewBox="0 0 937 853" enable-background="new 0 0 937 853" xml:space="preserve">
        <image id="image0" width="937" height="853" x="0" y="0" xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAA6kAAANVCAMAAACtUUjjAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
