<template>
  <div class="flex-col">
    ...
    <template v-if="!isLoading">
      ...
      /*FIXME: La api no trae los datos */
...
export default {
  ...
  methods: {
    ...
    getWebSite(exchange) {
      this.$set(exchange, 'isLoading', true) //Agregando REACTIVIDAD

      return api.getExchange(exchange.exchangeId)
        .then(res => {
          this.$set(exchange, 'url', res.exchangeUrl) //Agregando REACTIVIDAD
        })
        .finally(() => {
          this.$set(exchange, 'isLoading', false) //Seteando isLoading a false
